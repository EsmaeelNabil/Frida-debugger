setImmediate(function() {
	Java.perform(function() {
		...
		printStream.println.overload('int').implementation = function(var0) {
			send("[*] PrintStream.println('int') called with value: " + var0 + "\n");
			this.println(var0);
		};
